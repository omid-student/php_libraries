...
<head>
    ...
    <title>پنل مدیریت <?=config_item('project_title')?></title>
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        ...
                        <div class="p-2">
                            ...
                            <form class="form-horizontal m-t-20" action="panel/admin/login/try" method="post">

                                <div class="form-group row">
                                    <div class="col-12">
                                        <input class="form-control" type="text" required="required" name="username" placeholder="نام کاربری">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <div class="col-12">
                                        <input class="form-control" type="password" required="required" name="password" placeholder="رمز عبور">
                                    </div>
                                </div>

                                <div class="form-group text-center row m-t-20">
                                    <div class="col-12">
                                        <button class="btn btn-primary btn-block waves-effect waves-light" type="submit">ورود به حساب</button>
                                    </div>
                                </div>
